...
public class MainWindow extends JFrame
{
    ...
    protected void generateMainLayout() {
		...
		for(int i = 0; i < 5; i++)
		{
			...
			sidebarBorderDown.setBounds(0, (int) sidebarButtons[i].getBounds().getMaxY(), sidebarButtons[i].getBounds().width, 1);
...
//    	nextPageField.setFont(new Font("Arial", Font.PLAIN, 50));
    	...
    	{  
    	    ...
    	    {  
				...
				if 	((pageCount + 1)* 12 + 1 <= dataRows.size())
				{
					...
					JOptionPane.showMessageDialog(null, "No more data to show.", "End of data" ,JOptionPane.WARNING_MESSAGE);
...
//    	WITH PAGINATION
    ...
    public void updateNestedWindow() {
    	...
    	if(currentPageCode.equals("tutorial")) {
    		 ...
    		 * 
    		 */
    		htmlTable.setText("<html><head></head><body bgcolor=\"" + Colors.backgroundColorHex + "\" >"
